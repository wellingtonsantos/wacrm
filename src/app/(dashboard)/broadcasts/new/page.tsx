...
const steps = [
  ...
  { label: 'Público-alvo', key: 'audience' },
...
export default function NewBroadcastPage() {
  ...
  async function handleSend() {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : 'Falha no envio da transmissão';
  ...
  async function handleSaveDraft() {
    if (!template || !name.trim()) {
      toast.error('Dê um nome para a transmissão antes de salvar um rascunho.');
      return;
    }
