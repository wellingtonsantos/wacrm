        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-10 text-center">
            ...
            {canEditSettings ? (
              ...
              <p className="text-muted-foreground mt-1 text-xs">
                Solicite a um administrador para criar uma.
              </p>
            )}
          </CardContent>
        </Card>
        ...
        {createdKey ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                seguro — se você a perder, revogue-a e crie uma nova.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Dê um nome relacionado à integração que a utilizará e conceda apenas
