        ...
        <div className="flex items-end gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              ...
              title={
                readOnly
                  ? "Apenas leitura — seu papel não pode enviar mensagens"
                  : inputsDisabled
                    ? undefined
                    : "Anexar mídia"
              }
          ...
          <textarea
            ...
            placeholder={
              readOnly
                ? "Apenas leitura — visualizadores podem ler mas não responder"
                : sessionExpired
            ...
            title={readOnly ? "Apenas leitura — seu papel não pode enviar mensagens" : undefined}
            className={cn(
